      ...
      <article className="flex gap-4 items-center md:flex-row flex-col-reverse">
        <Card className="border-2 border-gray-200 hover:cursor-pointer transition duration-300 hover:shadow-xl">
          <CardHeader>
            ...
            <CardDescription>
              Our AI will improve your resume with proper formatting and language
            </CardDescription>
          </CardHeader>
          <CardFooter>
            <Button variant="outline" color="secondary" asChild>
              <Link href="/dashboard/resume-builder/upload">Upload resume</Link>
            </Button>
          </CardFooter>
        </Card>
        ...
        <Card className="bg-primaryLight hover:text-white hover:bg-primaryDark border-gray-200 hover:cursor-pointer transition duration-300 hover:shadow-xl">
          <CardHeader>
            ...
            <CardDescription className="text-dullLight">
              Select a template, add your information and voila ! Your new resume is ready
            </CardDescription>
          </CardHeader>

          <CardFooter>
            <Button variant="outline" color="secondary" asChild>
              <Link href="/dashboard/resume-builder/build">Build my new resume</Link>
            </Button>
          </CardFooter>
        </Card>
      </article>
