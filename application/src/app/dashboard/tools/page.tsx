...
export default function Tools() {
  ...
  return (
    <section>
      ...
      <Card onClick={() => setActiveResourceTab("cover-letters")} className={`${activeResourceTab === "cover-letters" && "border-4 border-primaryDark"} hover:cursor-pointer bg-primaryLight text-primaryDark`}>
        <CardHeader>
            <Mail size={40} />
      ...
      <Card onClick={() => setActiveResourceTab("interview-questions")} className={`${activeResourceTab === "interview-questions" && "border-4 border-sky-400"} hover:cursor-pointer bg-primaryDark text-white`}>
        <CardHeader>
      ...
      <Card onClick={() => setActiveResourceTab("headshots")} className={`${activeResourceTab === "headshots" && "border-4 border-primaryDark"} hover:cursor-pointer bg-primaryLight text-primaryDark`}>
        <CardHeader>
            <UserRound size={40} />
