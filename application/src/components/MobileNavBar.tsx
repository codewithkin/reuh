...
import { Dialog, DialogClose, DialogDescription, DialogContent, DialogFooter,DialogTitle, DialogHeader, DialogTrigger } from "./ui/dialog";
    ...
    return (
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Your information stored in Reuh
            </DialogDescription>
          </DialogHeader>
          <ProfileForm />
