    ...
    return (
        <article className="mx-8 md:mx-0 w-full even:bg-primaryLight rounded-2xl p-4 text-white font-semibold bg-dullDark flex flex-col gap-4">
            ...
            <article className="flex gap-2 justify-center items-center">
                <article className={`hover:cursor-pointer transition duration-400 hover:bg-primaryDark flex shadow shadow-xl items-center gap-2 ${resource.color} px-8 py-2 font-semibold rounded-full text-primaryDark text-center justify-center items-center`}>
                    {resource.percentage}% <ArrowUp />
                </article>
                <Link className="bg-primaryDark rounded-full text-white py-2 px-4" href="/">
                    New
                </Link>
            </article>
        </article>
